...
4- for Icons, always use lucide-vue. use like: import { Camera } from 'lucide-vue-next';
...
7- Modules and folder structure: major UI sections have folder under views folder. functionality related components should be under there.